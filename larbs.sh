...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/ianmubangizi/voidrice.git"
[ -z ${progsfile+x} ] && progsfile="https://raw.githubusercontent.com/ianmubangizi/LARBS/master/progs.csv"
