...
echo "options quiet modprobe.blacklist=nouveau acpi_backlight=video cryptdevice=UUID=$LUKS_UUID:arch:allow-discards root=/dev/mapper/arch-root rw" >> /boot/loader/entries/arch.conf
