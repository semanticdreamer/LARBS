...
curl https://raw.githubusercontent.com/semanticdreamer/LARBS/master/src/chroot-nvme1n1.sh > /mnt/chroot.sh && arch-chroot /mnt bash chroot.sh && rm /mnt/chroot.sh
